    ...
    <body>
        ...
        <div class="container">
            ...
            <table class="table">
                <tr>
                    <th>会社名</th>
                    <td><?php print htmlspecialchars($form_company, ENT_QUOTES, "UTF-8"); ?></td>
                </tr>
                <tr>
                    <th>氏名</th>
                    <td><?php print htmlspecialchars($form_name, ENT_QUOTES, "UTF-8"); ?></td>
                </tr>
                <tr>
                    <th>メール</th>
                    <td><?php print htmlspecialchars($form_mail, ENT_QUOTES, "UTF-8"); ?></td>
                </tr>
                <tr>
                    <th>電話番号</th>
                    <td><?php print htmlspecialchars($form_tel, ENT_QUOTES, "UTF-8"); ?></td>
                </tr>
                <tr>
                    <th>内容</th>
                    <td><?php print htmlspecialchars($form_content, ENT_QUOTES, "UTF-8"); ?></td>
                </tr>
            </table>
